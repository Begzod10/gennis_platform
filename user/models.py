...
class CustomPermission(models.Model):
    ...
    salary = models.IntegerField(max_length=100, blank=True, null=True)
...
class UserSalary(models.Model):
    ...
    total_salary = models.IntegerField(max_length=100, blank=True, null=True)
    taken_salary = models.IntegerField(max_length=100, blank=True, null=True)
    remaining_salary = models.IntegerField(max_length=100, blank=True, null=True)
