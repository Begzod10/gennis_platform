...
class MissionHistory(models.Model):
    ...
    management_executor_id = models.BigIntegerField(null=True, blank=True)
    management_executor_name = models.CharField(max_length=255, null=True, blank=True)
    management_reviewer_id = models.BigIntegerField(null=True, blank=True)
    management_reviewer_name = models.CharField(max_length=255, null=True, blank=True)
    gennis_executor_id = models.IntegerField(null=True, blank=True)
    gennis_executor_name = models.CharField(max_length=255, null=True, blank=True)
    gennis_reviewer_id = models.IntegerField(null=True, blank=True)
    gennis_reviewer_name = models.CharField(max_length=255, null=True, blank=True)
