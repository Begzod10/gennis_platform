...
INSTALLED_APPS = ['django.contrib.admin', 'django.contrib.auth', 'django.contrib.contenttypes',
    ...
    'teachers.apps.TeachersConfig', 'rooms.apps.RoomsConfig', 'class.apps.ClassConfig',
    'attendance.apps.AttendanceConfig', 'time_table.apps.TimeTableConfig', 'lead.apps.LeadConfig',
    'books.apps.BooksConfig', 'drf_yasg', 'djoser', 'django_cron', 'corsheaders', ]
