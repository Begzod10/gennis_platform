...
class LessonPlanFile(models.Model):
    ...
    subject   = models.ForeignKey('subjects.Subject', on_delete=models.SET_NULL, null=True, blank=True, related_name='lesson_plan_files')
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=['teacher', 'term', 'group', 'flow', 'subject'],
