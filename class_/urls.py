...
-delete
urlpatterns = [
    path('coin_info_create/<int:pk>/', CoinInfoCreateView.as_view(), name='coin-info-create'),
    ...
    path('class_coin_create/<int:pk>/', ClassCoinCreateView.as_view(), name='class-coin-create'),
